...
int __init virmouse_init(void)
{
        ...
        set_bit(REL_WHEEL, virmouse_input_dev->relbit);
         printk("%lu %d", *(virmouse_input_dev->relbit),REL_X);
